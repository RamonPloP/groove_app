...
class Students(db.Model):
    ...
    how_find_us = db.Column(Enum(SocialMediaType))
    ...
    blood_type = db.Column(Enum(BloodType))
    ...
    has_chronic_disease = db.Column(db.Boolean)
    chronic_disease = db.Column(db.String(50))
    has_allergies = db.Column(db.Boolean)
    allergies = db.Column(db.String(50))
    has_restricted_activities = db.Column(db.Boolean)
    restricted_activities = db.Column(db.String(50))
    has_mental_conditions = db.Column(db.Boolean)
